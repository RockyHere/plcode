 ...
 * 
 */
public class ExtendsAuthenticationFilter extends AbstractCasFilter {
	protected static final Log log = LogFactory
			.getLog(ExtendsAuthenticationFilter.class);
	/**
	...
	protected void initInternal(final FilterConfig filterConfig)
		...
		if (!isIgnoreInitConfiguration()) {
			...
			this.setCasServerLoginUrl(this.ServerNameConfigParameter
					+ this.contextPathConfigParameter + "/login");
			this.setServerName(ServerNameConfigParameter);
