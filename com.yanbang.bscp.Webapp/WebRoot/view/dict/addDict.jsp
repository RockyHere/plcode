...
<body>
	<form id="editForm" method="post">
		<input type="hidden" name="dictParentId" value="${dictParentId}" /> 
		<input type="hidden" name="dictCode" value="${dictCode}" />
		<input type="hidden" name="useStatus" value="0" />
		...
		<table  width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr style="height:25px">
				...
				<td width="70%">
					<input type="text" id="dictName" name="dictName" value=""  style="width:100%" />
				</td>
			</tr>
			<tr style="height:25px">
				<td class="tabSingleHeader">词条关键字</td>
				<td>
					<input type="text" id="dictKey" name="dictKey" ${dictKey==''?'':'readonly'} value="${dictKey}" style="width:100%"/>
				</td>
			</tr>
			<tr style="height:25px">
				<td class="tabSingleHeader">词条描述</td>
				<td><input type="text" id="dictDesc" name="dictDesc" value=""  style="width:100%"/></td>
			</tr>
			<tr style="height:25px">
				<td class="tabSingleHeader">排序</td>
				<td>
					<input type="text" id="orderKey" name="orderKey"  style="width:100%" value="" />
				</td>
			</tr>
			<tr style="height:25px">
				<td class="tabSingleHeader">词条等级</td>
				<td>
					<input type="text" id="dictGrade" name="dictGrade" readonly  style="width:100%" value="${dictGrade}" />
				</td>
			</tr>
			<tr>
				<td colspan="2" style="text-align:center;">
					<button type="button" onclick="saveDict();" class="btn_bg">确&nbsp;&nbsp;定</button>&nbsp;
