...
var setting = {
	...
	function initOrgForm(){
		$('#sysJobIframe').attr("src","sysJob.do?action=findMutiCondition&curPage=1&pageRows=10");
	}
	...
	function editOrgForm(treeNode){
		$('#sysJobIframe').attr("src","sysJob.do?action=findMutiCondition&curPage=1&pageRows=10&orgId="+treeNode.id);
