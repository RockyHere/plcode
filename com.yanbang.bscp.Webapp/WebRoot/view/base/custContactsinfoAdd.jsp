...
<script language="JavaScript" src="/resource/js/base/custContactsinfoAdd.js"></script>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr style="height:35px">
				<td colspan="4" style="text-align:center;">
					<button type="button" onclick="addSaveContactsinfo();" class="btn_bg">确&nbsp;&nbsp;定</button>&nbsp;
