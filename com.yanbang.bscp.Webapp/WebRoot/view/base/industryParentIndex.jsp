...
var setting = {
	...
	function initOrgForm(){
		$('#sysJobIframe').attr("src","baseIndustry.do?action=findMutiCondition&curPage=1&pageRows=10");
	}
	...
	function editOrgForm(treeNode){
		$('#sysJobIframe').attr("src","baseIndustry.do?action=findMutiCondition&curPage=1&pageRows=10&parentId="+treeNode.id);
