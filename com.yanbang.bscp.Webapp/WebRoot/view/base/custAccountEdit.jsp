...
<body>
	<form id="editForm" method="post">
		<input type="hidden" id="curPage" name="curPage" value="${curPage}" /> <input
			...
			value="${crm_cust_id}" /> <input type="hidden" id="crm_cust_account_id" name="crm_cust_account_id"
			style="width:100%" value="${account.crm_cust_account_id}" />
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr style="height:25px">
				<td class="tabSingleHeader" width="30%">账号名称</td>
				<td width="70%"><input type="text" id="cust_account_name"
					name="cust_account_name" value="${account.cust_account_name}" style="width:100%" /></td>
			</tr>
			<tr>
				<td class="tabSingleHeader" width="30%">账号编码</td>
				<td width="70%"><input type="text" id="cust_account_no"
					name="cust_account_no" value="${account.cust_account_no}" style="width:100%" /></td>
			</tr>
			<tr>
				<td class="tabSingleHeader" width="30%">备注</td>
				<td width="70%"><input type="text" id="memo"
					name="memo" value="${account.memo}" style="width:100%" /></td>
			</tr>
			
			<tr style="height:35px">
				<td colspan="4" style="text-align:center;">
					<button type="button" onclick="editSaveAccount();" class="btn_bg">确&nbsp;&nbsp;定</button>&nbsp;
