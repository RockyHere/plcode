...
public class JpdlGeometry {
	...
	public static Point getRectangleLineCrossPoint(Rectangle rectangle,
		...
		rect.grow(grow, grow);
		Point p0 = JpdlGeometry.getRectangleCenter(rect);
		...
		double slope = JpdlGeometry.getSlope(p0.x, p0.y, rect.x, rect.y);
		double slopeLine = JpdlGeometry.getSlope(p0.x, p0.y, p1.x, p1.y);
		double yIntercep = JpdlGeometry.getYIntercep(p0.x, p0.y, p1.x, p1.y);
