...
public interface IWorkFlowManageService {
	 ...
	 *            variable.put("taskuserName", "xuchunfu");
	 */
	 ...
	 *            endProcessInstance(pi.getId(), "ended");
	 */
	...
	public Page<WorkFlowHistoryProcess> findHistoryWorkFlowsByMutiConditon(
			Page<WorkFlowHistoryProcess> page, WorkFlowHistoryProcess wfhp);
