...
<body>
	...
	<table class="table" cellpadding="0" cellspacing="0" width="100%">
		<tr class="table_top" style="height:25px">
			...
			<td class="tabSingleHeader" style="width:40%;">机构名称</td>
			<td class="tabSingleHeader" style="width:30%;">上级银行</td>
			<td class="tabSingleHeader" style="width:20%;">备注</td>
		</tr>
		<c:forEach items="${page.pageResult}" var="finance" varStatus="status">
			<tr onmouseover="rowmouseover(this);"
				onclick="choiceItem('${finance.bas_financialins_id}','${finance.financialins_name}')"
				...
				<input type="hidden" name="bas_industry_id"
		...
		<tr style="width:1800px">
			<td class="tabFootBg" colspan="4"><input type="hidden"
