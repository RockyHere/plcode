...
<!-- <table>
    <tr>
        ...
        <td width="80%">
            <iframe id="postIframe" src="" width="1200px" height="600px"></iframe>
        </td>
     </tr>
</table> -->
<div >
   ...
   <div>
   	  <iframe id="postIframe" src=""  style="width:80%;height:100%;" ></iframe> 
   </div>
</div> 
...
var setting = {
	...
	function initOrgForm(){
		$('#postIframe').attr("src","sysPost.do?action=postPop&curPage=1&pageRows=10");
	}
	...
	function editOrgForm(treeNode){
		$('#postIframe').attr("src","sysPost.do?action=postPop&curPage=1&pageRows=10&orgId="+treeNode.id);
