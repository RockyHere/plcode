...
<script language="JavaScript" src="/resource/js/security/user.js"></script>
</head>
<body>
<div id="title"> 
 ...
 <div id="querybar">
   ...
   <div id="btnlist">
    <ul>
      ...
      <li><a onclick="funRole(${page.pageCurrent},${page.pagePerRows})"><img src="/resource/images/global/btnRole.jpg" align="middle"/></a></li>
      <li><a onclick="funResetUserPwd(${page.pageCurrent},${page.pagePerRows})"><img src="/resource/images/global/btnReSetPwd.jpg" align="middle"/></a></li>
    </ul>
    </div>
	<table class="table">
		<thead>
			...
			<c:forEach items="${page.pageResult}" var="usr" varStatus="status">
			  <tr onclick="selRadioByTr(this,'usercheck')" class="${status.count%2!=0?'tr1':'tr2'}" >
				...
				<c:if test="${usr.userStatus==1}">
				    <img src="/resource/images/global/disenable.png" style="border:none;width:16px;height:16px;" alt="停止"/>
				</c:if>
