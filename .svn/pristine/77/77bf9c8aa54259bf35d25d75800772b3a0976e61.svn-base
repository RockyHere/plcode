...
<script language="JavaScript" src="/resource/js/base/custAccount.js"></script>
</head>
<body>
	<!-- <div id="title"> 
	...
	<div id="btnlist">
		<ul>
			<li><a onclick="addAccount(${page.pageCurrent},${page.pagePerRows})"><img
					src="/resource/images/global/btnNew.jpg" align="middle"
					style="border:0px;" /></a></li>
			<li><a onclick="delAccount(${page.pageCurrent},${page.pagePerRows})"><img
					src="/resource/images/global/btnDel.jpg" align="middle"
					style="border:0px;" /></a></li>
			<li><a onclick="editAccount(${page.pageCurrent},${page.pagePerRows});"><img
					src="/resource/images/global/btnEdit.jpg" align="middle"
					style="border:0px;" /></a></li>
		</ul>
	</div>
	<input type="hidden" id="crm_cust_id"
				value="${account.crm_cust_id}">
<table class="table" cellpadding="0" cellspacing="0">
	<tr class="table_top" style="height:25px">
		...
		<td class="tabSingleHeader" style="width:200px">账号名称</td>
		<td class="tabSingleHeader" style="width:300px">账号编码</td>
		<td class="tabSingleHeader" style="width:300px">备注</td>
		
		
	</tr>
	<c:forEach items="${page.pageResult}" var="account" varStatus="status">
		<tr onmouseover="rowmouseover(this);"
		   ...
		   <c:if test="${status.count%2==0}">class="tr2" onmouseout="rowmouseout(this,'tr2')"</c:if>>
		  	<td align="center"><input type="checkbox" name="crm_cust_account_id" value="${account.crm_cust_account_id}"/></td>
		  	<td align="center">${account.cust_account_name}</td>
		  	<td align="center">${account.cust_account_no}</td>
		  	<td align="center">${account.memo}</td>
		 </tr>
	</c:forEach>
	<tr>
