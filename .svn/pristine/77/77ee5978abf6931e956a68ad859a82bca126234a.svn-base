...
<body >
	<form id="editForm" method="post">
		<input type="hidden" name="uuid" value="${sysJob.uuid}" /> 
		<input type="hidden" name="useFlag" value="${sysJob.useFlag}" /> 
		<input type="hidden" id="orgId" name="orgId" value="${sysJob.orgId}" />
		<input type="hidden" id="orgCode" name="orgCode" value="${sysJob.orgCode}" />
		<input type="hidden" id="orgName" name="orgName" value="${sysJob.orgName}" />
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr style="height:25px">
				...
				<td width="70%">
					<span>${sysJob.orgCode}_${sysJob.orgName}</span>
				</td>
			</tr>
			<tr style="height:25px">
				<td class="tabSingleHeader"  width="30%">职位代码</td>
				<td width="70%">
					<input type="text" id="jobCode" name="jobCode" value="${sysJob.jobCode }"  style="width:100%" />
				</td>
			</tr>
			<tr>
				<td class="tabSingleHeader"  width="30%">职位名称</td>
				<td width="70%">
					<input type="text" id="jobName" name="jobName" value="${sysJob.jobName }" style="width:100%"/>
				</td>
			</tr>
			<tr style="height:25px">
				<td class="tabSingleHeader"  width="30%">备注</td>
				<td  width="70%" >
                    <input type="text" id="comments" name="comments" value="${sysJob.comments }" style="width:100%"/>
				</td>
			</tr>
			<tr>
