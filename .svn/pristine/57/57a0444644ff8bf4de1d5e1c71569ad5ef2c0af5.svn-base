...
<div id="title"> 
   ...
   <span id="tname">金融机构管理</span>
</div>
<div >
   <div class="treeDiv" style="float:left;width:15%;height:100%;margin-top:-10px;">
...
var setting = {
	...
	function initOrgForm(){
		$('#sysJobIframe').attr("src","baseFinance.do?action=findMutiCondition&curPage=1&pageRows=10");
	}
	...
	function editOrgForm(treeNode){
		$('#sysJobIframe').attr("src","baseFinance.do?action=findMutiCondition&curPage=1&pageRows=10&parentid="+treeNode.id);
