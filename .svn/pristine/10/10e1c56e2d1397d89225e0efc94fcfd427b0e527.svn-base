...
<script language="JavaScript" src="/resource/js/security/role.js"></script>
</head>
<body>
<div id="title"> 
 ...
 <div id="querybar">
   ...
   <div id="btnlist">
    <ul>
      ...
      <li><a onclick="funMenu(${page.pageCurrent},${page.pagePerRows})"><img src="/resource/images/global/btnMenu.jpg" align="middle"/></a></li>
    </ul>
    </div>
