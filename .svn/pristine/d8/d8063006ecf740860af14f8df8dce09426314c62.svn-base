	...
	<div id="main">
	 <table class="table" cellpadding="0" cellspacing="0" width="100%">
		  <tr  class="table_top" style="height:25px">
			 ...
			 <td  class="tabSingleHeader" style="width:15%;">
				 <span>单位名称</span>
			  </td>
			  ...
			  <td  class="tabSingleHeader"  style="width:7%;">
				 <span>实例图</span>
			  </td>
		  </tr>
		  ...
		  <c:forEach items="${wftlist}" var="task" varStatus="status">
		  	<tr onmouseover="rowmouseover(this);" 
		  		...
		  		<td align="center">${task.taskFlowTypeName }</td>
		  		...
		  		<td align="center">${task.startDate }</td>
		  		<td align="center">${task.endDate }</td>
		  		<td align="center">${task.duration}</td>
		  		<td align="center">
			       <img src="/resource/images/admin/flow.png" onclick="funViewHistoryFlowIntance('${task.taskExecuteId}','${task.taskFlowName}','${task.taskFLowKey}')" title="查看流程图"/>
