...
<link rel="icon" href="/resource/images/portal/logon16x16.ico" type="image/x-icon" />
<link rel="shortcut icon" href="/resource/images/portal/logon32x32.ico" type="image/x-icon" />
<link rel="bookmark" href="/resource/images/portal/logon16x16.ico" type="image/x-icon" />
<link rel="stylesheet" type="text/css" href="/resource/css/portal/logo.css">
...
<script type="text/javascript" src="/resource/js/global/jquery.min.js"></script>
<script type="text/javascript" src="/resource/js/portal/logo.js"></script>
<title style="font-family:STXingkai;">新远科技协同服务平台</title>
</head>
          ...
          <table width="419px;" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr style="height:50px;" >
                ...
                <td class="tdbg">
                    ...
                    <img src="/bscp/portal.do?action=handleRnd" align="top" style="cursor:hand;" onclick="checkRnd(this)" title="看不清"/>
                  </td>
                <td colspan="3" rowspan="2"><img src="/resource/images/portal/logo_40.png" class="btnlogo" onClick="handleSubmit()"></td>
              </tr>
