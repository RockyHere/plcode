...
<script language="JavaScript"
	src="/resource/js/base/custReceivinfo.js"></script>
...
<body>
	<form id="editForm" method="post">
		...
		<input type="hidden" id="crm_cust_id" name="crm_cust_id"
			style="width:100%" value="${crm_cust_id}" /> <input type="hidden"
			id="crm_cust_receivinfo_id" name="crm_cust_receivinfo_id"
			style="width:100%" value="${receivinfo.crm_cust_receivinfo_id}" />

		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr style="height:25px">
				<td class="tabSingleHeader" width="30%">姓名</td>
				<td width="70%"><input type="text" id="receive_name"
					name="receive_name" value="${receivinfo.receive_name}"
					style="width:100%" /></td>
			</tr>
			<tr>
				<td class="tabSingleHeader" width="30%">身份证号</td>
				<td width="70%"><input type="text" id="receive_idcard"
					name="receive_idcard" value="${receivinfo.receive_idcard}"
					style="width:100%" /></td>
			</tr>
			<tr>
				<td class="tabSingleHeader" width="30%">固话</td>
				<td width="70%"><input type="text" id="receive_phone"
					name="receive_phone" value="${receivinfo.receive_phone}"
					style="width:100%" /></td>
			</tr>
			<tr>
				<td class="tabSingleHeader" width="30%">移动电话</td>
				<td width="70%"><input type="text" id="receive_mobile"
					name="receive_mobile" value="${receivinfo.receive_mobile}"
					style="width:100%" /></td>
			</tr>
			<tr>
				<td class="tabSingleHeader" width="30%">收货地址</td>
				<td width="70%"><input type="text" id="receive_addr"
					name="receive_addr" value="${receivinfo.receive_addr}"
					style="width:100%" /></td>
			</tr>
			<tr>
				<td class="tabSingleHeader" width="30%">收货详细地址</td>
				<td width="70%"><input type="text" id="receive_addr_detail"
					name="receive_addr_detail"
					value="${receivinfo.receive_addr_detail}" style="width:100%" /></td>
			</tr>

			<tr style="height:35px">
				<td colspan="4" style="text-align:center;">
					<button type="button" onclick="editSaveReceivinfo();"
						class="btn_bg">确&nbsp;&nbsp;定</button>&nbsp;
