...
<table class="table" cellpadding="0" cellspacing="0" width="100%">
	<tr class="table_top" style="height:25px">
		...
		<td class="tabSingleHeader" style="width:10%;">名称</td>
		<td class="tabSingleHeader" style="width:10%;">上级行业</td>
		<td class="tabSingleHeader" style="width:21%;margin: 3px;">备注</td>
		<td class="tabSingleHeader" style="width:10%;">创建人</td>
		<td class="tabSingleHeader" style="width:12%;">创建时间</td>
		<td class="tabSingleHeader" style="width:10%;">更新人</td>
		<td class="tabSingleHeader" style="width:12%;">更新时间</td>
	...
	<c:forEach items="${page.pageResult}" var="sysJob" varStatus="status">
		<tr onmouseover="rowmouseover(this);"
		   ...
		   <c:if test="${status.count%2==0}">class="tr2" onmouseout="rowmouseout(this,'tr2')"</c:if>>
		  	...
		  	<td align="center">${sysJob.parentName}</td>
