...
function changeLeftMenu() {
	...
	if (showLeftMenuFlg) {
		resizeObj.cols = "0, *";
		document.getElementById("leftMenu").src = "/resource/images/portal/hidden.gif";
	} else {
		resizeObj.cols = "180, *";
		document.getElementById("leftMenu").src = "/resource/images/portal/show.gif";
	}
...
function changeusrPwd(){
	...
	$.post("portal.do?action=updateUserPwd", {
		...
		if (result.result == "succ") {
			alert("修改密码成功");
			window.location.href="/bscp/portal.do?action=portalRight";
		} else {
			alert("修改密码失败");
		}
	});
